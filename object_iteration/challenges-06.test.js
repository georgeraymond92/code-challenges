...
const totalCharacters = (arr) => {
  // Solution code here...
  let numOfChars = '';
  for(let properties in characters){
      numOfChars++;
  }
  return numOfChars;
}
...
const getHouses = (arr) => {
  ...
  // Solution code here...
  for(let properties in characters){
      houses.push(characters[properties].house);
    }
  return houses;
}
...
const hasChildrenValues = (arr, character) => {
  ...
  for(let properties in arr){
        if(Object.values(arr)[properties].name === character && Object.values(arr)[properties].children.length > 0){
            hasChildren = true;
        }
    };
    return hasChildren;
...
const hasChildrenEntries = (arr, character) => {
  ...
  // Solution code here...
  for(let properties in arr){
        if(Object.entries(arr)[properties][1].name === character && Object.entries(arr)[properties][1].children.length > 0){
            hasChildren = true;
        }
    };
    return hasChildren;
...
const houseSize = (arr) => {
  ...
  //   console.log(sizes);
  // }else{
  //   for(let properties in sizes){
  //     console.log(Object.values(sizes)[properties].house);
  //     for(let properties in sizes){
  //       console.log(Object.values(sizes)[properties].house);
  //       console.log(Object.values(arr)[properties].house);

  //      if(Object.values(sizes)[properties].house === Object.values(arr)[properties].house){
  //         Object.values(sizes)[properties].members++;
  //       }else{
  //         sizes.push({house: Object.values(arr)[properties].house, members: 1 });
  //       }
  //     }
  //   }
  // }
